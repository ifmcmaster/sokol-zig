...
pub const Params = extern struct {
    ...
    renderUpdate: ?*const fn (?*anyopaque, [*c]c_int, [*c]const u8) callconv(.C) void = null,
};
...
pub extern fn fonsDrawText(s: ?*Context, x: f32, y: f32, string: [*c]const u8, end: [*c]const u8) f32;
